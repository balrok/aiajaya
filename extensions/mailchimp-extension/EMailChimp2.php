...
class EMailChimp2 extends MailChimpBase
{
	...
	public function createCampaign($subject, $from_email, $from_name, $to_name, $html_content, $txt_content)
	{
        $params = array(
			'type'=>'regular',
			'options'=>array(
        ...
        $retval = $this->call('campaigns/create', $params);
		return $retval;
	}

	public function sendtestCampaign($id, $emails=array())
	{
		$params = array('cid'=>$id, 'test_emails'=>$emails);
        $retval = $this->call('campaigns/send-test', $params);
		return $retval;
	}
	...
	{
		$params = array('cid'=>$id);
        $retval = $this->call('campaigns/send', $params);
		return $retval;
	}
}
