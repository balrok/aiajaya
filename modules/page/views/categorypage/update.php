...
Yii::app()->clientScript->registerScript('autocomplete_img_renderer','
	...
	jQuery.ui.autocomplete.prototype._renderItem = function(ul, item ) {              
		if(this.element[0].id.substr(0, 7) != "pageimg") {
...
echo $form->hiddenField($model,'categorykey');
echo $form->hiddenField($model,'categoryname');


foreach ($models as $model)
	echo $this->renderPartial('_form', array('model'=>$model, 'allpages'=>$allpages, 'allimages'=>$allimages, 'form'=>$form));
?>
